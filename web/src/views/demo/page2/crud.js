  ...
  return {
    ...
    columns: [
      ...
      },
      {
        ...
        type: 'select',
        dict: {
          data: [{ value: '1', label: 'يفتح', color: 'success' }, { value: '0', label: 'إنهاء', color: 'danger' }, { value: '2', label: 'قف', color: 'info' }]
        }
      },
      {
        ...
        // component: { props: { color: 'auto' } } // install.js إعداداتالصباغة التلقائية
      }
    ]
  }
}
